...
function validate(name, fields, vm) {
  ...
  // validate at first
  for (var _iterator = getObjeckValues(fields), _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
    var _ref;
...
function validateField(field, validation) {
  ...
  //
  var rules = getObjeckValues(field._resolvedRules);
  var index = 0;
  var next = void 0,
      end = void 0;
  next = function () {
    ...
    validation.validating = getObjeckValues(validation.fields).find(function (field) {
...
function subError(rule, field, validation) {
  ...
  validation.valid = getObjeckValues(validation.fields).every(function (field) {
    return field.valid;
  });
}
...
function createValidation(name, fields, vm) {
  return {
    ...
    setDirty: function (to) {
      this.dirty = to;
      getObjeckValues(this.fields).forEach(function (v) {
        v.dirty = to;
      });
      return this;
    },
    ...
    pause: function () {
      getObjeckValues(this.fields).forEach(function (field) {
...
function initFields(validation, vm) {
  var _loop = function (key) {
    ...
    for (var _iterator3 = getObjeckValues(field._resolvedRules), _isArray3 = Array.isArray(_iterator3), _i3 = 0, _iterator3 = _isArray3 ? _iterator3 : _iterator3[Symbol.iterator]();;) {
      var _ref3;
