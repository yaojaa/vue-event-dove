    ...
    <div class="event-wrap">
        <div class="ui small container">
            <div class="white-wrap p-lg">
                ...
                <div class="ui basic text-center segment" v-for="(order,index) in orderInfo.attendees">
                    <h4></h4>
                    <svg width="148" height="148" v-html="allEwm[index]" xmlns="http://www.w3.org/2000/svg" class="ui centered image"></svg>
...
export default {
    ...
    methods: {  
        ...
        getAttendee () {
            $.ajax({
                url: API_URL + "/attendee/getAllAttendee",
                type: "GET",
                data: {
            ...
            .done((data, textStatus, jqXHR) => {
                ...
                for(var i=0; i<this.orderInfo.attendees.length; i++){
                    var item=this.orderInfo.attendees[i];
                    this.generateQRcode(item.barcode)
                }
        ...
        generateQRcode (obj) {
            ...
            .done((data, textStatus, jqXHR) => {
                this.allEwm.push($(data.documentElement).html())
