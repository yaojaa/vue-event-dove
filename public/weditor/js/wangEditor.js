...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        $table.on('click', 'td', function (e) {
            ...
            var i, j;
            var tableHtml = '<table class="ui celled table">';
            for (i = 0; i < rownum; i++) {
                tableHtml += '<tr>';
    ...
    E.plugin(function () {
        ...
        fns.onload || (fns.onload = function (resultText, xhr) {
            ...
            if (resultText.error) {
                ...
                img.onload = function () {
                    var html = '<img src="http://okxpbi18m.bkt.clouddn.com/' + resultText.key + '" alt="' + originalName + '" style="max-width:100%;"/>';
                ...
                img.src = 'http://okxpbi18m.bkt.clouddn.com/'+resultText.key ;
            }
    ...
    E.plugin(function () {
        ...
        editor.xhrUploadImg = function (opt) {
            ...
            if(opt.file){
              ...
              formData.append('key', Math.random()+opt.file.name) //名称和随机数
            }else{
...
_e(function (E, $) {
    ...
    UploadFile.fn.upload = function (file) {
        ...
        E.log('开始执行 ' + filename + ' 文件的上传'+file.size);
